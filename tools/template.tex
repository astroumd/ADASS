...
% Version 23-jun-2021 (Peter Teuben)
...
% leave the ssindex lines commented for the editors, use Index.py to suggest yours
${NOCOMMENT}\ssindex{FOOBAR!conference!ADASS 2021}
${NOCOMMENT}\ssindex{FOOBAR!organisations!ASP}

% leave the ooindex lines commented for the editors, use ascl.py to suggest yours
