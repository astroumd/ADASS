...
% Version 30-oct-2018 (Peter Teuben)
...
an empty ${PCODE}.bib. When you add references to this,
add a line \verb+\bibliography{${PCODE}}+  right before end of the document, make use ``make'' to
