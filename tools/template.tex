...
% Version 6-dec-2018 (Peter Teuben)
...
Makefile how to do this. Just remember they need to be EPS files,
and you can use the very easy to use \verb+\articlefigure+ macro.
\section{Final Check}
...
your beautifully looking PDF. Only use the citep and citet macros.
